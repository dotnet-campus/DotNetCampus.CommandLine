...
public class LegacyOptionsParser : ICommandLineOptionParser<LegacyOptions>
{
    ...
    public LegacyOptions Commit()
    {
        return new LegacyOptions(_filePath, _isFromCloud, _startupMode, _isSilence, _isIwb, _placement, _startupSession);
    }
}
