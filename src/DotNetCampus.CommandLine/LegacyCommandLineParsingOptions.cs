...
/// </summary>
public readonly record struct LegacyCommandLineParsingOptions()
{
    /// <inheritdoc cref="LegacyCommandLineStyle.Flexible" />
    public static LegacyCommandLineParsingOptions Flexible => new LegacyCommandLineParsingOptions
    {
        Style = LegacyCommandLineStyle.Flexible,
        CaseSensitive = false,
    };

    /// <inheritdoc cref="LegacyCommandLineStyle.Gnu" />
    public static LegacyCommandLineParsingOptions Gnu => new LegacyCommandLineParsingOptions
    {
        Style = LegacyCommandLineStyle.Gnu,
        CaseSensitive = true,
    };

    /// <inheritdoc cref="LegacyCommandLineStyle.Posix" />
    public static LegacyCommandLineParsingOptions Posix => new LegacyCommandLineParsingOptions
    {
        Style = LegacyCommandLineStyle.Posix,
        CaseSensitive = true,
    };

    /// <inheritdoc cref="LegacyCommandLineStyle.DotNet" />
    public static LegacyCommandLineParsingOptions DotNet => new LegacyCommandLineParsingOptions
    {
        Style = LegacyCommandLineStyle.DotNet,
        CaseSensitive = false,
    };

    /// <inheritdoc cref="LegacyCommandLineStyle.PowerShell" />
    public static LegacyCommandLineParsingOptions PowerShell => new LegacyCommandLineParsingOptions
    {
        Style = LegacyCommandLineStyle.PowerShell,
        CaseSensitive = false,
    };
    ...
    /// </remarks>
    public LegacyCommandLineStyle Style { get; init; }
