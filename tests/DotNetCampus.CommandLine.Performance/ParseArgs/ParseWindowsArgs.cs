...
[MemoryDiagnoser]
[BenchmarkCategory("Parse Windows Args")]
public class ParseWindowsArgs
{
    [Benchmark(Description = "parse [PS1] -v=4.1 -p=flexible")]
    public void Parse41_Flexible()
    {
        var commandLine = CommandLine41.Parse(WindowsArgs, Options41.Flexible);
        commandLine.As<BenchmarkOptions41>();
    }

    [Benchmark(Description = "parse [PS1] -v=4.1 -p=windows")]
    public void Parse41_Windows()
    {
        var commandLine = CommandLine41.Parse(WindowsArgs, Options41.Windows);
        commandLine.As<BenchmarkOptions41>();
    }
    ...
    {
        var commandLine = CommandLine40.Parse(WindowsArgsFor40, Options40.Flexible);
    ...
    {
        var commandLine = CommandLine40.Parse(WindowsArgsFor40, Options40.PowerShell);
        commandLine.As<BenchmarkOptions40>();
    }
    ...
    {
        var commandLine = CommandLine3.Parse(WindowsArgs);
