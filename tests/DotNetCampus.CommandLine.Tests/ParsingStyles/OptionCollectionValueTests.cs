...
public class OptionCollectionValueTests
{
    ...
    [DataRow(new[] { "-Option", "a", "-Option", "b" }, TestCommandLineStyle.Windows, DisplayName = "[Gnu] -Option a -Option b")]
    ...
    [DataRow(new[] { "-o", "a", "-o", "b" }, TestCommandLineStyle.Windows, DisplayName = "[Windows] -o a -o b")]
    // option a,b
    ...
    [DataRow(new[] { "-Option", "a,b" }, TestCommandLineStyle.Windows, DisplayName = "[Windows] -Option a,b")]
    ...
    [DataRow(new[] { "-o", "a,b" }, TestCommandLineStyle.Windows, DisplayName = "[Windows] -o a,b")]
    // option a;b
    [DataRow(new[] { "--option", "a;b" }, TestCommandLineStyle.Flexible, DisplayName = "[Flexible] --option a;b")]
    [DataRow(new[] { "--option", "a;b" }, TestCommandLineStyle.DotNet, DisplayName = "[DotNet] --option a;b")]
    [DataRow(new[] { "--option", "a;b" }, TestCommandLineStyle.Gnu, DisplayName = "[Gnu] --option a;b")]
    ...
    [DataRow(new[] { "--option=a", "--option=b" }, TestCommandLineStyle.DotNet, DisplayName = "[DotNet] --option=a --option=b")]
    [DataRow(new[] { "--option=a", "--option=b" }, TestCommandLineStyle.Gnu, DisplayName = "[Gnu] --option=a --option=b")]
    [DataRow(new[] { "-Option=a", "-Option=b" }, TestCommandLineStyle.Windows, DisplayName = "[Windows] -Option=a -Option=b")]
    ...
    [DataRow(new[] { "-Option=a", "b,c" }, TestCommandLineStyle.Windows, DisplayName = "[Windows] -Option=a b,c")]
